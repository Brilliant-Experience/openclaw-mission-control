  ...
  return (
    <html lang="en" suppressHydrationWarning>
      ...
      <body className={`${inter.variable} ${geistMono.variable} antialiased`}>
        <ThemeProvider>
          {/* OpsContextProvider wraps everything inside ThemeProvider so that
              any page can register its context and the OpsConsole can read it.
              It must be a client-side boundary; SetupGate and children remain
              inside so they inherit the context. */}
          <OpsContextProvider>
            <SetupGate>
              <KeyboardShortcuts />
              <div className="flex h-screen overflow-hidden bg-stone-50 text-stone-900 dark:bg-[#101214] dark:text-stone-100">
                ...
                {/* OpsConsole panel — added in unit-1; reads context via
                    useOpsConsoleContext() from OpsContextProvider above. */}
                <OpsConsole />
              </div>
              <AgentChatPanel />
