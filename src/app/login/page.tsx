        ...
        <div className="rounded-2xl border border-white/5 bg-[#171a1d] p-6 shadow-xl">
          <div className="space-y-4">
            ...
            <button
              ...
              disabled={loading}
              className="flex w-full items-center justify-center gap-3 rounded-lg bg-white px-4 py-2.5 text-sm font-medium text-stone-800 transition-all hover:bg-stone-100 disabled:opacity-40"
            >
              {loading ? (
            ...
            <p className="text-center text-xs text-stone-600">
              Restricted to Brilliant Experience accounts
            </p>
          </div>
        </div>
